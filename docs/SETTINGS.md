...
포탈 상단 **설정** 메뉴의 37개 화면을 화면 순서대로 설명한다. 각 항목은
...
### 31. NFS 마운트(백업 대상) — `#/settings/nfs-mounts`
- **무엇**: 백업을 저장할 NFS 마운트를 등록·확인한다.
- **저장**: `nfs-mounts.json`
- **권한**: admin

### 32. 폴더 사용량 리포트 — `#/settings/dir-usage`
...
### 33. vCenter 로그 보관 — `#/settings/vclogs`
