...
| [`/api`](#api) | 321 | 포탈 화면이 쓰는 **주 조회·작업 API**. `authMiddleware + requireEnrolled` 뒤이고, `/tools/*` 는 `toolGate` 가 사용자별 도구 권한을 집행한다. |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/bm-usage` | — | [server/src/routes/collector.js:170](../server/src/routes/collector.js#L170) |
| POST | `/bmstor-collect` | `express.json` | [server/src/routes/collector.js:257](../server/src/routes/collector.js#L257) |
| GET | `/edge-log` | — | [server/src/routes/collector.js:141](../server/src/routes/collector.js#L141) |
| GET | `/export` | — | [server/src/routes/collector.js:105](../server/src/routes/collector.js#L105) |
| POST | `/idrac-scan` | `express.json` | [server/src/routes/collector.js:233](../server/src/routes/collector.js#L233) |
| GET | `/ping` | — | [server/src/routes/collector.js:122](../server/src/routes/collector.js#L122) |
| POST | `/set-password` | `express.json` | [server/src/routes/collector.js:213](../server/src/routes/collector.js#L213) |
| GET | `/token-check` | — | [server/src/routes/collector.js:198](../server/src/routes/collector.js#L198) |
| POST | `/upgrade` | `express.raw` | [server/src/routes/collector.js:274](../server/src/routes/collector.js#L274) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/history` | — | [server/src/routes/capacity.js:58](../server/src/routes/capacity.js#L58) |
| GET | `/host` | — | [server/src/routes/capacity.js:46](../server/src/routes/capacity.js#L46) |
| GET | `/summary` | — | [server/src/routes/capacity.js:31](../server/src/routes/capacity.js#L31) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/anomalies` | — | [server/src/routes/insights.js:201](../server/src/routes/insights.js#L201) |
| POST | `/chatops` | — | [server/src/routes/insights.js:267](../server/src/routes/insights.js#L267) |
| GET | `/finops` | — | [server/src/routes/insights.js:39](../server/src/routes/insights.js#L39) |
| GET | `/finops/config` | — | [server/src/routes/insights.js:57](../server/src/routes/insights.js#L57) |
| PUT | `/finops/config` | 역할 `admin` | [server/src/routes/insights.js:82](../server/src/routes/insights.js#L82) |
| GET | `/fleet` | — | [server/src/routes/insights.js:85](../server/src/routes/insights.js#L85) |
| PUT | `/fleet/assign` | 역할 `admin` | [server/src/routes/insights.js:132](../server/src/routes/insights.js#L132) |
| PUT | `/fleet/assign-bulk` | 역할 `admin` | [server/src/routes/insights.js:148](../server/src/routes/insights.js#L148) |
| POST | `/fleet/prune` | 역할 `admin` | [server/src/routes/insights.js:182](../server/src/routes/insights.js#L182) |
| PUT | `/fleet/tag` | 역할 `admin` | [server/src/routes/insights.js:105](../server/src/routes/insights.js#L105) |
| GET | `/forecast` | — | [server/src/routes/insights.js:221](../server/src/routes/insights.js#L221) |
| GET | `/graph` | — | [server/src/routes/insights.js:246](../server/src/routes/insights.js#L246) |
| GET | `/incidents` | — | [server/src/routes/insights.js:261](../server/src/routes/insights.js#L261) |
| GET | `/power-breakdown` | — | [server/src/routes/insights.js:60](../server/src/routes/insights.js#L60) |
| GET | `/security` | — | [server/src/routes/insights.js:233](../server/src/routes/insights.js#L233) |
| GET | `/topology` | — | [server/src/routes/insights.js:236](../server/src/routes/insights.js#L236) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| POST | `/agent-config` | — | [server/src/routes/central.js:1214](../server/src/routes/central.js#L1214) |
| GET | `/assignment` | — | [server/src/routes/central.js:232](../server/src/routes/central.js#L232) |
| GET | `/bmstor-jobs` | — | [server/src/routes/central.js:1278](../server/src/routes/central.js#L1278) |
| POST | `/bmstor-result` | — | [server/src/routes/central.js:1284](../server/src/routes/central.js#L1284) |
| POST | `/capacity-report` | — | [server/src/routes/central.js:364](../server/src/routes/central.js#L364) |
| GET | `/capture-jobs` | — | [server/src/routes/central.js:1259](../server/src/routes/central.js#L1259) |
| POST | `/capture-result` | — | [server/src/routes/central.js:1265](../server/src/routes/central.js#L1265) |
| POST | `/curuser` | — | [server/src/routes/central.js:625](../server/src/routes/central.js#L625) |
| GET | `/curuser-config` | — | [server/src/routes/central.js:670](../server/src/routes/central.js#L670) |
| GET | `/edge-log-jobs` | — | [server/src/routes/central.js:873](../server/src/routes/central.js#L873) |
| POST | `/edge-log-result` | — | [server/src/routes/central.js:882](../server/src/routes/central.js#L882) |
| POST | `/fleet` | — | [server/src/routes/central.js:702](../server/src/routes/central.js#L702) |
| GET | `/gpu-guest-config` | — | [server/src/routes/central.js:805](../server/src/routes/central.js#L805) |
| POST | `/gpu-guest-data` | — | [server/src/routes/central.js:753](../server/src/routes/central.js#L753) |
| POST | `/guest-disk` | — | [server/src/routes/central.js:496](../server/src/routes/central.js#L496) |
| GET | `/health-probe` | — | [server/src/routes/central.js:1347](../server/src/routes/central.js#L1347) |
| GET | `/idrac-scan-jobs` | — | [server/src/routes/central.js:714](../server/src/routes/central.js#L714) |
| POST | `/idrac-scan-progress` | — | [server/src/routes/central.js:721](../server/src/routes/central.js#L721) |
| POST | `/idrac-scan-result` | — | [server/src/routes/central.js:733](../server/src/routes/central.js#L733) |
| POST | `/inventory` | — | [server/src/routes/central.js:440](../server/src/routes/central.js#L440) |
| GET | `/ip-scan-assignment` | — | [server/src/routes/central.js:1301](../server/src/routes/central.js#L1301) |
| POST | `/ip-scan-result` | — | [server/src/routes/central.js:1310](../server/src/routes/central.js#L1310) |
| POST | `/link-check` | — | [server/src/routes/central.js:1363](../server/src/routes/central.js#L1363) |
| GET | `/link-check-config` | — | [server/src/routes/central.js:1393](../server/src/routes/central.js#L1393) |
| GET | `/log-queries` | — | [server/src/routes/central.js:1232](../server/src/routes/central.js#L1232) |
| POST | `/log-query-result` | — | [server/src/routes/central.js:1241](../server/src/routes/central.js#L1241) |
| POST | `/part-faults` | — | [server/src/routes/central.js:849](../server/src/routes/central.js#L849) |
| GET | `/partfault-config` | — | [server/src/routes/central.js:903](../server/src/routes/central.js#L903) |
| GET | `/pdu-config` | — | [server/src/routes/central.js:938](../server/src/routes/central.js#L938) |
| POST | `/pdu-data` | — | [server/src/routes/central.js:958](../server/src/routes/central.js#L958) |
| GET | `/ping-jobs` | — | [server/src/routes/central.js:1189](../server/src/routes/central.js#L1189) |
| POST | `/ping-result` | — | [server/src/routes/central.js:1199](../server/src/routes/central.js#L1199) |
| POST | `/register-collector` | — | [server/src/routes/central.js:243](../server/src/routes/central.js#L243) |
| POST | `/result` | — | [server/src/routes/central.js:309](../server/src/routes/central.js#L309) |
| POST | `/rma-credential` | — | [server/src/routes/central.js:1118](../server/src/routes/central.js#L1118) |
| POST | `/rma-poll` | — | [server/src/routes/central.js:1064](../server/src/routes/central.js#L1064) |
| POST | `/rma-result` | — | [server/src/routes/central.js:1140](../server/src/routes/central.js#L1140) |
| GET | `/sanswitch-config` | — | [server/src/routes/central.js:981](../server/src/routes/central.js#L981) |
| POST | `/sanswitch-data` | — | [server/src/routes/central.js:1153](../server/src/routes/central.js#L1153) |
| POST | `/sanswitch-perf` | — | [server/src/routes/central.js:1006](../server/src/routes/central.js#L1006) |
| POST | `/sanswitch-test-result` | — | [server/src/routes/central.js:1043](../server/src/routes/central.js#L1043) |
| GET | `/storage-config` | — | [server/src/routes/central.js:822](../server/src/routes/central.js#L822) |
| POST | `/storage-data` | — | [server/src/routes/central.js:913](../server/src/routes/central.js#L913) |
| GET | `/svcmon-config` | — | [server/src/routes/central.js:411](../server/src/routes/central.js#L411) |
| POST | `/svcmon-config-ack` | — | [server/src/routes/central.js:427](../server/src/routes/central.js#L427) |
| POST | `/svcmon-report` | — | [server/src/routes/central.js:338](../server/src/routes/central.js#L338) |
| GET | `/users-config` | — | [server/src/routes/central.js:1178](../server/src/routes/central.js#L1178) |
| POST | `/vmseries` | — | [server/src/routes/central.js:569](../server/src/routes/central.js#L569) |
| GET | `/vmseries-config` | — | [server/src/routes/central.js:690](../server/src/routes/central.js#L690) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| POST | `/apply` | 역할 `admin` | [server/src/routes/upgrade.js:146](../server/src/routes/upgrade.js#L146) |
| POST | `/bundle` | 역할 `admin` · `express.raw` | [server/src/routes/upgrade.js:188](../server/src/routes/upgrade.js#L188) |
| POST | `/check` | 역할 `admin` | [server/src/routes/upgrade.js:140](../server/src/routes/upgrade.js#L140) |
| GET | `/detect-install` | 역할 `admin` | [server/src/routes/upgrade.js:165](../server/src/routes/upgrade.js#L165) |
| POST | `/restart` | 역할 `admin` | [server/src/routes/upgrade.js:154](../server/src/routes/upgrade.js#L154) |
| GET | `/settings` | 역할 `admin` | [server/src/routes/upgrade.js:160](../server/src/routes/upgrade.js#L160) |
| PUT | `/settings` | 역할 `admin` | [server/src/routes/upgrade.js:175](../server/src/routes/upgrade.js#L175) |
| GET | `/status` | 역할 `admin` | [server/src/routes/upgrade.js:135](../server/src/routes/upgrade.js#L135) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/config` | 역할 `admin` | [server/src/routes/remote.js:130](../server/src/routes/remote.js#L130) |
| PUT | `/config` | 역할 `admin` | [server/src/routes/remote.js:132](../server/src/routes/remote.js#L132) |
| POST | `/deploy` | 역할 `admin` | [server/src/routes/remote.js:205](../server/src/routes/remote.js#L205) |
| POST | `/deploy/test` | 역할 `admin` | [server/src/routes/remote.js:190](../server/src/routes/remote.js#L190) |
| GET | `/mappings` | 권한 `remote.access` | [server/src/routes/remote.js:42](../server/src/routes/remote.js#L42) |
| POST | `/mappings` | 역할 `admin` | [server/src/routes/remote.js:221](../server/src/routes/remote.js#L221) |
| DELETE | `/mappings/:id` | 권한 `remote.access` | [server/src/routes/remote.js:270](../server/src/routes/remote.js#L270) |
| POST | `/mappings/:id/apply` | 역할 `admin` | [server/src/routes/remote.js:259](../server/src/routes/remote.js#L259) |
| POST | `/probe` | 권한 `remote.access` | [server/src/routes/remote.js:79](../server/src/routes/remote.js#L79) |
| GET | `/proxies` | 권한 `remote.access` | [server/src/routes/remote.js:107](../server/src/routes/remote.js#L107) |
| POST | `/proxies` | 역할 `admin` | [server/src/routes/remote.js:141](../server/src/routes/remote.js#L141) |
| DELETE | `/proxies/:id` | 역할 `admin` | [server/src/routes/remote.js:145](../server/src/routes/remote.js#L145) |
| POST | `/proxies/:id/health` | 역할 `admin` | [server/src/routes/remote.js:152](../server/src/routes/remote.js#L152) |
| GET | `/proxies/full` | 역할 `admin` | [server/src/routes/remote.js:140](../server/src/routes/remote.js#L140) |
| POST | `/quick-connect` | 권한 `remote.access` | [server/src/routes/remote.js:232](../server/src/routes/remote.js#L232) |
| POST | `/rdp-ticket` | 권한 `remote.access` | [server/src/routes/remote.js:30](../server/src/routes/remote.js#L30) |
| GET | `/rdp/:id` | 권한 `remote.access` | [server/src/routes/remote.js:285](../server/src/routes/remote.js#L285) |
| GET | `/targets` | 권한 `remote.access` | [server/src/routes/remote.js:113](../server/src/routes/remote.js#L113) |
| POST | `/test` | 역할 `admin` | [server/src/routes/remote.js:175](../server/src/routes/remote.js#L175) |
...
| GET | `/batches` | 역할 `admin/operator` | [server/src/routes/svcmon/generate.js:177](../server/src/routes/svcmon/generate.js#L177) |
| DELETE | `/batches/:id` | 역할 `admin/operator` | [server/src/routes/svcmon/generate.js:192](../server/src/routes/svcmon/generate.js#L192) |
| POST | `/batches/:id/rollback` | 역할 `admin/operator` | [server/src/routes/svcmon/generate.js:179](../server/src/routes/svcmon/generate.js#L179) |
...
| POST | `/targets/generate` | 역할 `admin/operator` | [server/src/routes/svcmon/generate.js:94](../server/src/routes/svcmon/generate.js#L94) |
...
| POST | `/edge-users-bulk` | 역할 `admin` · `requireSettingsOwner` | [server/src/routes/admin/gpuGuest.js:148](../server/src/routes/admin/gpuGuest.js#L148) |
| GET | `/edge-users/:agent` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:134](../server/src/routes/admin/gpuGuest.js#L134) |
| POST | `/edge-users/:agent` | 역할 `admin` · `requireSettingsOwner` | [server/src/routes/admin/gpuGuest.js:143](../server/src/routes/admin/gpuGuest.js#L143) |
| DELETE | `/edge-users/:agent/:username` | 역할 `admin` · `requireSettingsOwner` | [server/src/routes/admin/gpuGuest.js:154](../server/src/routes/admin/gpuGuest.js#L154) |
| GET | `/edge-users/agents` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:123](../server/src/routes/admin/gpuGuest.js#L123) |
...
| GET | `/gpu-guest/deploy/:agent` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:109](../server/src/routes/admin/gpuGuest.js#L109) |
| PUT | `/gpu-guest/deploy/:agent` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:113](../server/src/routes/admin/gpuGuest.js#L113) |
| GET | `/gpu-guest/deploy/agents` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:99](../server/src/routes/admin/gpuGuest.js#L99) |
| GET | `/gpu-guest/diag` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:60](../server/src/routes/admin/gpuGuest.js#L60) |
| GET | `/gpu-guest/settings` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:49](../server/src/routes/admin/gpuGuest.js#L49) |
| PUT | `/gpu-guest/settings` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:52](../server/src/routes/admin/gpuGuest.js#L52) |
| POST | `/gpu-guest/test` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:254](../server/src/routes/admin/gpuGuest.js#L254) |
| POST | `/gpu-guest/test-ssh` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:344](../server/src/routes/admin/gpuGuest.js#L344) |
| GET | `/gpu-guest/vms` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:66](../server/src/routes/admin/gpuGuest.js#L66) |
| GET | `/gpu-physical` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:160](../server/src/routes/admin/gpuGuest.js#L160) |
| POST | `/gpu-physical` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:163](../server/src/routes/admin/gpuGuest.js#L163) |
| DELETE | `/gpu-physical/:id` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:173](../server/src/routes/admin/gpuGuest.js#L173) |
| PUT | `/gpu-physical/:id` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:168](../server/src/routes/admin/gpuGuest.js#L168) |
| POST | `/gpu-physical/auto-register` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:182](../server/src/routes/admin/gpuGuest.js#L182) |
| POST | `/gpu-physical/bulk-auto-register` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:206](../server/src/routes/admin/gpuGuest.js#L206) |
| POST | `/gpu-physical/poll` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:177](../server/src/routes/admin/gpuGuest.js#L177) |
| POST | `/gpu-physical/test` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:238](../server/src/routes/admin/gpuGuest.js#L238) |
| POST | `/gpu/collect-util` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:35](../server/src/routes/admin/gpuGuest.js#L35) |
...
| GET | `/metrics/settings` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:26](../server/src/routes/admin/gpuGuest.js#L26) |
| PUT | `/metrics/settings` | 역할 `admin` | [server/src/routes/admin/gpuGuest.js:29](../server/src/routes/admin/gpuGuest.js#L29) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/ad-config` | 역할 `admin` · `authMiddleware` · `requireEnrolled` | [server/src/routes/auth.js:215](../server/src/routes/auth.js#L215) |
| PUT | `/ad-config` | 역할 `admin` · `authMiddleware` · `requireEnrolled` · `requireSettingsOwner` | [server/src/routes/auth.js:223](../server/src/routes/auth.js#L223) |
| POST | `/ad-test` | 역할 `admin` · `authMiddleware` · `requireEnrolled` | [server/src/routes/auth.js:228](../server/src/routes/auth.js#L228) |
| GET | `/config` | — | [server/src/routes/auth.js:18](../server/src/routes/auth.js#L18) |
| POST | `/extend` | `authMiddleware` | [server/src/routes/auth.js:154](../server/src/routes/auth.js#L154) |
| POST | `/login` | — | [server/src/routes/auth.js:38](../server/src/routes/auth.js#L38) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/edge/overview` | — | [server/src/routes/ping.js:113](../server/src/routes/ping.js#L113) |
| POST | `/edge/sync` | 역할 `admin` | [server/src/routes/ping.js:123](../server/src/routes/ping.js#L123) |
| POST | `/poll-now` | 역할 `admin` | [server/src/routes/ping.js:102](../server/src/routes/ping.js#L102) |
| POST | `/seed-vcenters` | 역할 `admin` | [server/src/routes/ping.js:107](../server/src/routes/ping.js#L107) |
| GET | `/series` | — | [server/src/routes/ping.js:84](../server/src/routes/ping.js#L84) |
| GET | `/status` | — | [server/src/routes/ping.js:68](../server/src/routes/ping.js#L68) |
| GET | `/targets` | — | [server/src/routes/ping.js:79](../server/src/routes/ping.js#L79) |
| POST | `/targets` | 역할 `admin` | [server/src/routes/ping.js:94](../server/src/routes/ping.js#L94) |
| DELETE | `/targets/:id` | 역할 `admin` | [server/src/routes/ping.js:96](../server/src/routes/ping.js#L96) |
| PUT | `/targets/:id` | 역할 `admin` | [server/src/routes/ping.js:95](../server/src/routes/ping.js#L95) |
| GET | `/vcport/overview` | — | [server/src/routes/ping.js:129](../server/src/routes/ping.js#L129) |
| GET | `/vcport/ports` | — | [server/src/routes/ping.js:143](../server/src/routes/ping.js#L143) |
| PUT | `/vcport/ports` | 역할 `admin` | [server/src/routes/ping.js:145](../server/src/routes/ping.js#L145) |
| POST | `/vcport/sync` | 역할 `admin` | [server/src/routes/ping.js:150](../server/src/routes/ping.js#L150) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/` | — | [server/src/routes/metricsExport.js:24](../server/src/routes/metricsExport.js#L24) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/` | — | [server/src/routes/publicApi.js:98](../server/src/routes/publicApi.js#L98) |
| GET | `/capacity/datastores` | `guarded` | [server/src/routes/publicApi.js:192](../server/src/routes/publicApi.js#L192) |
| GET | `/capacity/storage` | `guarded` | [server/src/routes/publicApi.js:207](../server/src/routes/publicApi.js#L207) |
| GET | `/capacity/storage-growth` | `guarded` | [server/src/routes/publicApi.js:238](../server/src/routes/publicApi.js#L238) |
| GET | `/faults/alarms` | `guarded` | [server/src/routes/publicApi.js:268](../server/src/routes/publicApi.js#L268) |
| GET | `/faults/parts` | `guarded` | [server/src/routes/publicApi.js:283](../server/src/routes/publicApi.js#L283) |
| GET | `/inventory/collection` | `guarded` | [server/src/routes/publicApi.js:166](../server/src/routes/publicApi.js#L166) |
| GET | `/inventory/summary` | `guarded` | [server/src/routes/publicApi.js:115](../server/src/routes/publicApi.js#L115) |
| GET | `/inventory/vcenters` | `guarded` | [server/src/routes/publicApi.js:151](../server/src/routes/publicApi.js#L151) |
| GET | `/openapi.json` | — | [server/src/routes/publicApi.js:108](../server/src/routes/publicApi.js#L108) |
...
| GET | `/tools/esxi-temp/history` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:1182](../server/src/routes/api/toolsCapacity.js#L1182) |
| POST | `/tools/esxi-temp/spark` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:1244](../server/src/routes/api/toolsCapacity.js#L1244) |
...
| GET | `/tools/groups` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:337](../server/src/routes/api/toolsCapacity.js#L337) |
...
| GET | `/tools/ipam` | 권한 `tools` | [server/src/routes/api/ipamExport.js:69](../server/src/routes/api/ipamExport.js#L69) |
| GET | `/tools/ipam.csv` | 권한 `tools` | [server/src/routes/api/ipamExport.js:398](../server/src/routes/api/ipamExport.js#L398) |
| GET | `/tools/ipam.xlsx` | 권한 `tools` | [server/src/routes/api/ipamExport.js:385](../server/src/routes/api/ipamExport.js#L385) |
| GET | `/tools/ipam/annotation` | 권한 `tools` | [server/src/routes/api/ipamExport.js:181](../server/src/routes/api/ipamExport.js#L181) |
| PUT | `/tools/ipam/annotation` | 권한 `tools` | [server/src/routes/api/ipamExport.js:192](../server/src/routes/api/ipamExport.js#L192) |
| POST | `/tools/ipam/bulk` | 권한 `tools` | [server/src/routes/api/ipamExport.js:273](../server/src/routes/api/ipamExport.js#L273) |
| GET | `/tools/ipam/history` | 권한 `tools` | [server/src/routes/api/ipamExport.js:112](../server/src/routes/api/ipamExport.js#L112) |
| GET | `/tools/ipam/insights` | 권한 `tools` | [server/src/routes/api/ipamExport.js:95](../server/src/routes/api/ipamExport.js#L95) |
| DELETE | `/tools/ipam/ip/:ip` | 권한 `tools` | [server/src/routes/api/ipamExport.js:259](../server/src/routes/api/ipamExport.js#L259) |
| GET | `/tools/ipam/ip/:ip` | 권한 `tools` | [server/src/routes/api/ipamExport.js:220](../server/src/routes/api/ipamExport.js#L220) |
| PUT | `/tools/ipam/ip/:ip` | 권한 `tools` | [server/src/routes/api/ipamExport.js:232](../server/src/routes/api/ipamExport.js#L232) |
| GET | `/tools/ipam/manage-meta` | 권한 `tools` | [server/src/routes/api/ipamExport.js:208](../server/src/routes/api/ipamExport.js#L208) |
| GET | `/tools/ipam/netmap` | 권한 `tools` | [server/src/routes/api/ipamExport.js:147](../server/src/routes/api/ipamExport.js#L147) |
| GET | `/tools/ipam/policies` | 권한 `tools` | [server/src/routes/api/ipamExport.js:295](../server/src/routes/api/ipamExport.js#L295) |
| POST | `/tools/ipam/policies` | 권한 `tools` | [server/src/routes/api/ipamExport.js:326](../server/src/routes/api/ipamExport.js#L326) |
| DELETE | `/tools/ipam/policies/:id` | 권한 `tools` | [server/src/routes/api/ipamExport.js:370](../server/src/routes/api/ipamExport.js#L370) |
| PUT | `/tools/ipam/policies/:id` | 권한 `tools` | [server/src/routes/api/ipamExport.js:343](../server/src/routes/api/ipamExport.js#L343) |
| GET | `/tools/ipam/policies/ip/:ip` | 권한 `tools` | [server/src/routes/api/ipamExport.js:304](../server/src/routes/api/ipamExport.js#L304) |
| GET | `/tools/ipam/policies/preview` | 권한 `tools` | [server/src/routes/api/ipamExport.js:321](../server/src/routes/api/ipamExport.js#L321) |
| GET | `/tools/ipam/scan-report.csv` | 권한 `tools` | [server/src/routes/api/ipamExport.js:156](../server/src/routes/api/ipamExport.js#L156) |
| GET | `/tools/ipam/sheet` | 권한 `tools` | [server/src/routes/api/ipamExport.js:105](../server/src/routes/api/ipamExport.js#L105) |
| GET | `/tools/ipam/subnets` | 권한 `tools` | [server/src/routes/api/ipamExport.js:101](../server/src/routes/api/ipamExport.js#L101) |
| GET | `/tools/ipam/vc-ranges` | 권한 `tools` | [server/src/routes/api/ipamExport.js:120](../server/src/routes/api/ipamExport.js#L120) |
| GET | `/tools/ipam/vc-ranges.csv` | 권한 `tools` | [server/src/routes/api/ipamExport.js:135](../server/src/routes/api/ipamExport.js#L135) |
...
| GET | `/tools/part-faults` | 권한 `tools` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:131](../server/src/routes/api/partFaults.js#L131) |
| POST | `/tools/part-faults/close` | 역할 `admin` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:200](../server/src/routes/api/partFaults.js#L200) |
| GET | `/tools/part-faults/events` | 권한 `tools` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:155](../server/src/routes/api/partFaults.js#L155) |
| GET | `/tools/part-faults/reset` | 권한 `tools` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:215](../server/src/routes/api/partFaults.js#L215) |
| POST | `/tools/part-faults/scan` | 역할 `admin/operator` · 권한 `tools` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:169](../server/src/routes/api/partFaults.js#L169) |
| PUT | `/tools/part-faults/settings` | 역할 `admin` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:187](../server/src/routes/api/partFaults.js#L187) |
| GET | `/tools/part-faults/status` | 권한 `tools` · `fullScopeOnly` | [server/src/routes/api/partFaults.js:177](../server/src/routes/api/partFaults.js#L177) |
...
| GET | `/tools/portal-check/tokens` | 역할 `admin` · `fullScopeOnly` | [server/src/routes/api/portalCheck.js:155](../server/src/routes/api/portalCheck.js#L155) |
| POST | `/tools/portal-check/tokens/edge-pull` | 역할 `admin` · `fullScopeOnly` | [server/src/routes/api/portalCheck.js:220](../server/src/routes/api/portalCheck.js#L220) |
| POST | `/tools/portal-check/tokens/probe` | 역할 `admin` · `fullScopeOnly` | [server/src/routes/api/portalCheck.js:188](../server/src/routes/api/portalCheck.js#L188) |
...
| GET | `/tools/rightsize` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:943](../server/src/routes/api/toolsCapacity.js#L943) |
...
| GET | `/tools/thin-vms` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:988](../server/src/routes/api/toolsCapacity.js#L988) |
| GET | `/tools/threats` | 권한 `tools` | [server/src/routes/api/toolsAnalytics.js:96](../server/src/routes/api/toolsAnalytics.js#L96) |
| GET | `/tools/vclogs` | 권한 `tools` | [server/src/routes/api/checksLogs.js:145](../server/src/routes/api/checksLogs.js#L145) |
| GET | `/tools/vclogs/export.csv` | 권한 `tools` | [server/src/routes/api/checksLogs.js:156](../server/src/routes/api/checksLogs.js#L156) |
| GET | `/tools/vclogs/federate` | 권한 `tools` | [server/src/routes/api/checksLogs.js:133](../server/src/routes/api/checksLogs.js#L133) |
| POST | `/tools/vclogs/federate` | 권한 `tools` | [server/src/routes/api/checksLogs.js:124](../server/src/routes/api/checksLogs.js#L124) |
| GET | `/tools/vclogs/sources` | 권한 `tools` | [server/src/routes/api/checksLogs.js:113](../server/src/routes/api/checksLogs.js#L113) |
...
| GET | `/tools/vm-export` | 권한 `tools` | [server/src/routes/api/ipamExport.js:74](../server/src/routes/api/ipamExport.js#L74) |
| GET | `/tools/vm-export.csv` | 권한 `tools` | [server/src/routes/api/ipamExport.js:83](../server/src/routes/api/ipamExport.js#L83) |
| POST | `/tools/vm-finder` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:1016](../server/src/routes/api/toolsCapacity.js#L1016) |
...
| DELETE | `/tools/vmseries/data` | 역할 `admin` | [server/src/routes/api/vmSeries.js:144](../server/src/routes/api/vmSeries.js#L144) |
| GET | `/tools/vmseries/local` | 권한 `tools` | [server/src/routes/api/vmSeries.js:108](../server/src/routes/api/vmSeries.js#L108) |
| POST | `/tools/vmseries/run` | 역할 `admin` | [server/src/routes/api/vmSeries.js:102](../server/src/routes/api/vmSeries.js#L102) |
| GET | `/tools/vmseries/scope-data` | 권한 `tools` | [server/src/routes/api/vmSeries.js:88](../server/src/routes/api/vmSeries.js#L88) |
| GET | `/tools/vmseries/settings` | 권한 `tools` | [server/src/routes/api/vmSeries.js:35](../server/src/routes/api/vmSeries.js#L35) |
| PUT | `/tools/vmseries/settings` | 역할 `admin` | [server/src/routes/api/vmSeries.js:52](../server/src/routes/api/vmSeries.js#L52) |
| GET | `/tools/vmseries/status` | 권한 `tools` | [server/src/routes/api/vmSeries.js:98](../server/src/routes/api/vmSeries.js#L98) |
| GET | `/tools/vmseries/top` | 권한 `tools` | [server/src/routes/api/vmSeries.js:122](../server/src/routes/api/vmSeries.js#L122) |
...
| GET | `/tools/waste` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:212](../server/src/routes/api/toolsCapacity.js#L212) |
| GET | `/tools/waste/export` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:384](../server/src/routes/api/toolsCapacity.js#L384) |
| GET | `/tools/waste/history` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:571](../server/src/routes/api/toolsCapacity.js#L571) |
| GET | `/tools/waste/off-check` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:548](../server/src/routes/api/toolsCapacity.js#L548) |
| POST | `/tools/waste/off-check/run` | 역할 `admin` | [server/src/routes/api/toolsCapacity.js:556](../server/src/routes/api/toolsCapacity.js#L556) |
| PUT | `/tools/waste/off-check/settings` | 역할 `admin` | [server/src/routes/api/toolsCapacity.js:551](../server/src/routes/api/toolsCapacity.js#L551) |
| GET | `/tools/waste/off-since` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:348](../server/src/routes/api/toolsCapacity.js#L348) |
| GET | `/tools/waste/settings` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:760](../server/src/routes/api/toolsCapacity.js#L760) |
| PUT | `/tools/waste/settings` | 역할 `admin` | [server/src/routes/api/toolsCapacity.js:781](../server/src/routes/api/toolsCapacity.js#L781) |
| DELETE | `/tools/waste/settings/data` | 역할 `admin` | [server/src/routes/api/toolsCapacity.js:817](../server/src/routes/api/toolsCapacity.js#L817) |
| POST | `/tools/waste/spark` | 권한 `tools` | [server/src/routes/api/toolsCapacity.js:849](../server/src/routes/api/toolsCapacity.js#L849) |
...
| GET | `/vcenters/:id/usage-history` | — | [server/src/routes/api/toolsCapacity.js:648](../server/src/routes/api/toolsCapacity.js#L648) |
...
| POST | `/vms/usage` | 권한 `inv.vms` | [server/src/routes/api/toolsCapacity.js:257](../server/src/routes/api/toolsCapacity.js#L257) |
...
| 메서드 | 경로 | 게이트(공통 제외) | 소스 |
|---|---|---|---|
| GET | `/:file` | — | [server/src/routes/dlsource.js:80](../server/src/routes/dlsource.js#L80) |
| GET | `/versions.json` | — | [server/src/routes/dlsource.js:76](../server/src/routes/dlsource.js#L76) |
