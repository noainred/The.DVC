...
export const TOOLS = [
  ...
  { k: 'storage-mon', icon: '🗄️', label: '스토리지 모니터링', desc: '글로벌 법인 스토리지(Isilon 우선 — XtremIO·PowerStore·PowerMax 등 확장 예정) 사용량·버전·계정·노드 통합 조회 · 엣지 현지 수집→중앙 집계 · 법인별/타입별 뷰', adminOnly: true },
