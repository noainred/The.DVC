...
export const TOOLS = [
  ...
  { k: 'storage-track', icon: '💾', label: '스토리지 사용량 추이', desc: 'vCenter 데이터스토어 용량·사용량·사용률 매일 00시·12시 추이(VM 수량 추이와 같은 스냅샷) · vCenter별 현재/증감 표 · 일평균 증가량과 가용 소진 예상(선형 추정) · 증감 클릭 시 변화 데이터스토어 상세' },
