...
// 인증 거부 기록은 v2.579 에 `collector/denyLog.js` 로 옮겼다(ARCH-03 — collector/agent 가 이 라우트
// 파일을 import 하던 순환 제거). 테스트 하니스가 이 파일에서 두 이름을 가져가므로 재수출한다.
export { getCollectorDenyStats, _resetCollectorDenyStats };
