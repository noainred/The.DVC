...
# 카테고리는 화면 색상과 1:1 로 묶여 있다(웹 static/app.js 의 CATEGORY_STYLE 참조).
CATEGORIES = [
    {"key": "Monitoring & Metrics", "label": "모니터링 & 메트릭"},
    {"key": "Infrastructure & DCIM", "label": "인프라 & DCIM"},
    {"key": "Network & Traffic", "label": "네트워크 & 트래픽"},
    {"key": "Security & IAM", "label": "보안 & IAM"},
    {"key": "Incidents & Operations", "label": "장애 & 운영"},
    {"key": "Storage & Backup", "label": "스토리지 & 백업"},
    {"key": "Custom Shortcuts", "label": "커스텀 링크"},
]

CATEGORY_KEYS = [c["key"] for c in CATEGORIES]
DEFAULT_CATEGORY = "Custom Shortcuts"

_DEFAULT_SHORTCUTS = [
    {
        "id": "sc-grafana", "name": "Grafana Global Metrics",
        "url": "https://grafana.internal.dc/d/global-overview",
        "category": "Monitoring & Metrics", "icon": "📈",
    ...
    },
    {
        ...
        "category": "Infrastructure & DCIM", "icon": "🗄️",
    ...
    },
    {
        ...
        "category": "Infrastructure & DCIM", "icon": "📦",
    ...
    },
    {
        ...
        "category": "Incidents & Operations", "icon": "🛟",
    ...
    },
    {
        ...
        "category": "Network & Traffic", "icon": "🕸️",
